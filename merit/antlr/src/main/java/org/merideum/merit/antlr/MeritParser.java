...
public class MeritParser extends Parser {
	...
	public static final int
		...
		IDENTIFIER=7, COLON=8, COMMA=9, PAREN_L=10, PAREN_R=11, BRACKET_L=12, 
		BRACKET_R=13, CURLY_L=14, SC_WS=15, IMPORT=16, ASSIGN=17, MINUS=18, DOT=19, 
		RETURN=20, CONST=21, VAR=22, RESOURCE_NAME=23, SC_CURLY_L=24, CAPITAL_LETTER=25, 
		LETTER=26, INTEGER=27, QUOTE_DOUBLE=28, DOLLAR_CURLY_L=29, ESCAPE_SEQUENCE=30, 
		TEXT=31, CURLY_R=32;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, "'import'", "'='", null, null, 
			"'return'", "'const'", "'var'", null, null, null, null, null, null, "'${'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"IDENTIFIER", "COLON", "COMMA", "PAREN_L", "PAREN_R", "BRACKET_L", "BRACKET_R", 
			"CURLY_L", "SC_WS", "IMPORT", "ASSIGN", "MINUS", "DOT", "RETURN", "CONST", 
			"VAR", "RESOURCE_NAME", "SC_CURLY_L", "CAPITAL_LETTER", "LETTER", "INTEGER", 
